...
private:
   ...
   */ // TODO
  BSTIterator(BSTNode<Data>* currTemp) {
	curr=currTemp; 
  }
...
public:
  ...
  bool operator==(BSTIterator<Data> const & other) const {
	/*Checks if the two iterator pointers are pointing to the same tree root called curr*/	
	return curr == curr.other; 	
  }

  /** Inequality test operator. */ // TODO
  bool operator!=(BSTIterator<Data> const & other) const {
	/*Checks if the two iterator pointers are not pointing to the same tree root called curr*/ 
